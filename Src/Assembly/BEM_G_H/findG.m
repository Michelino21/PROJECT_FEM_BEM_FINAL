% Calculates the G matrix coefficient related to the given set of points.
%
...
function [g_c] = findG(met, c, xi, yi, x1, y1, x2, y2, x3, y3)

    f = @(t) shape_fun(met, c, t)                                       ...
             .*                                                         ...
             intG(met, xi, yi, x1, y1, x2, y2, x3, y3, t)               ...
             .*                                                         ...
